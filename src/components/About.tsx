...
export default function About() {
  return (
    <section id="about" className="relative py-24 sm:py-32 bg-ink-900 overflow-hidden">
      {/* Section label */}
      <div className="absolute top-8 left-0 right-0 flex justify-center pointer-events-none">
        <span className="font-display text-stroke text-6xl sm:text-8xl uppercase opacity-30 select-none">
          The Garage
        </span>
      </div>
